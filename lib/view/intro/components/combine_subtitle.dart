...
import 'package:flutter_my_portfolio/view/intro/components/subtitle_text.dart';
      ...
      children: [
        const Responsive(
          desktop: AnimatedSubtitleText(
              textColor: textColor, start: 30, end: 40, text: 'Flutter '),
          largeMobile: AnimatedSubtitleText(
              textColor: textColor, start: 30, end: 25, text: 'Flutter '),
          mobile: AnimatedSubtitleText(
              textColor: textColor, start: 25, end: 20, text: 'Flutter '),
          tablet: AnimatedSubtitleText(
              textColor: textColor, start: 40, end: 30, text: 'Flutter '),
        ),
